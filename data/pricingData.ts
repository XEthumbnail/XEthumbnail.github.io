...
export const pricingData: PricingItem[] = [
  {
    ...
    ctaLink: 'mailto:XEthumbnail@gmail.com?subject=Free%20Trial',
    ctaText: 'Claim Free',
    isFeatured: false,
    buttonStyle: 'tonal'
  },
  {
    ...
    ctaLink: 'mailto:XEthumbnail@gmail.com?subject=Standard%20Order',
    ctaText: 'Order Now',
    isFeatured: true,
    badge: 'Most Popular',
    buttonStyle: 'primary'
  },
  {
    ...
    ctaLink: 'mailto:XEthumbnail@gmail.com?subject=Bulk%20Order',
    ctaText: 'Order Pack',
    isFeatured: false,
    buttonStyle: 'tonal'
  }
